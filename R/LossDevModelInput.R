...
##' The base input class for all models in \pkg{BALD}.
##'
...
##' A generic function to run models in \pkg{BALD}.
...
##' A method to run models in \pkg{BALD}.
##'
...
##'
##' \pkg{BALD} sets the seed in each chain from a random number generated inside of \code{R}.
