...
//newly added function
	//std::vector<double const*> const &parameters(unsigned int chain, StochasticNode const * _knots_Node) const;
	double const*parameters(unsigned int chain, StochasticNode const * _knots_Node, unsigned int x);
