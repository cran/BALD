...
const
{
    ...
    vector<StochasticNode *> stoch_nodes = gv.stochasticChildren();
...
vector<Sampler*> RJumpSplineFactory::makeSamplers(std::list<StochasticNode*> const &nodes, Graph const &graph) const
{
    vector<Sampler*> samplers;
    set<StochasticNode*> nodesThatWillBeSampled;
    for(std::list<StochasticNode*>::const_iterator p=nodes.begin(); p != nodes.end(); ++p)
    {
